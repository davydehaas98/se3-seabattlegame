...
public interface ISeaBattleGame {
     ...
     */
    int registerPlayer(String name, ISeaBattleGUI application, boolean singlePlayerMode);
     ...
     */
    boolean placeShipsAutomatically(int playerNr);
     ...
     */
    boolean removeShip(int playerNr, int posX, int posY);
     ...
     */
    boolean removeAllShips(int playerNr);
     ...
     */
    ShotType fireShotPlayer(int playerNr, int posX, int posY);
     ...
     * @return result of the shot
     */
    ShotType fireShotOpponent(int playerNr);
     ...
     */
    boolean startNewGame(int playerNr);

    //SeaBattleGame getInstance();
